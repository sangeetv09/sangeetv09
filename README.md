...
<br>💫 About Me:
<br>🔭I am a Senior DevOps Engineer with over 8 years of experience, currently working at Tocomulus (Dubai), specializing in DevOps and Cloud technologies with a strong emphasis on automation, CI/CD, and cloud infrastructure. Previously, I worked at TGK Streamline Solutions (India), where I developed a solid foundation in DevOps best practices, cloud automation, and scalable CI/CD implementations across multiple environments. I am a dedicated and results-driven DevOps professional with proven expertise in designing, implementing, and maintaining robust CI/CD pipelines using AWS, Azure DevOps, Jenkins, and GitLab CI/CD, enabling faster, secure, and reliable application delivery. My technical skill set includes source code management using Git, Infrastructure as Code (IaC) leveraging Terraform and Ansible, and extensive experience with Jenkins CI/CD processes and DevOps methodologies. I am passionate about continuous improvement and am seeking professional growth opportunities in DevOps technologies and Cloud Infrastructure.
